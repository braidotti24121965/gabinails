...
function Clients({ data, onNew, onAction, onArchive, onRestore }: { data: ClientItem[]; onNew: () => void; onAction: (mode: "view" | "edit", index: number) => void; onArchive: (index: number) => void; onRestore: (index: number) => void; }) { 
